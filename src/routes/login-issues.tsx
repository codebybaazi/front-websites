        ...
        <div className="container max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-8 leading-[0.9]">
              Fairplay <span className="text-primary">login</span> issues
            </h1>
        ...
        <div className="container max-w-4xl mx-auto px-4">
          <div className="space-y-6">
            {steps.map((step, i) => (
              ...
              >
                <div className="p-5 bg-white/5 rounded-xl shrink-0 group-hover:scale-110 transition-transform duration-500">
        ...
        <div className="container max-w-5xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold mb-8 tracking-tight leading-none">
              Need the <span className="text-primary underline decoration-primary/30 underline-offset-8">cricket desk</span>?
            </h2>
