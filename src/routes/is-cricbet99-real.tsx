...
export const Route = createFileRoute("/is-cricbet99-real")({
  head: () => ({
    meta: [
      { title: "Is Cricbet99 Real or Fake? Legitimacy Verified" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify(buildBreadcrumbJsonLd("/is-cricbet99-real", "Is Cricbet99 Real or Fake?")),
      },
  ...
  return (
    <LongFormPage
      ...
      relatedLinks={[
        ...
        { to: "/is-cricbet99-safe", label: "Is Cricbet99 Safe?", desc: "Security, encryption and payout trust signals explained." },
      ]}
      extra={
        <AiOverview
