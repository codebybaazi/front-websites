  ...
  return (
    <div className="flex flex-col bg-background text-foreground min-h-screen">
      ...
      <div className="container max-w-7xl mx-auto px-4 py-12">
        ...
        {/* Open-an-ID CTA */}
        <section className="mt-24 py-14 px-8 rounded-xl bg-gradient-to-br from-primary to-flame relative overflow-hidden">
          <div className="relative z-10 flex flex-col items-center text-center space-y-6">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-primary-foreground leading-[1.08]">
              Open the fixture on a Fairplay ID
            </h2>
            <p className="text-primary-foreground/80 text-[15px] max-w-xl leading-relaxed">
              Cricket, football and tennis from this calendar share one login. IPL and the T20 World Cup sit on the same wallet.
            </p>
            <Link 
              to="/fairplay-id"
              className="px-8 py-3.5 bg-ink-deep text-primary rounded-md text-sm font-semibold hover:bg-ink-deep/90 transition-colors flex items-center gap-2"
            >
              Open a Fairplay ID
