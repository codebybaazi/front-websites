        ...
        <div className="container max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-bold tracking-widest uppercase mb-8">
              <Globe className="w-4 h-4" /> International Glory
            </div>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter italic mb-8 leading-[0.9]">
              T20 World Cup <span className="text-primary not-italic">betting</span>
            </h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="glass-card p-8 md:p-12 border-primary/10">
              <h2 className="text-3xl font-black italic uppercase mb-6 flex items-center gap-3">
                ...
                Expert Tournament <span className="text-primary">Analysis</span>
              </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
                   <div className="space-y-4">
                      ...
                      <ul className="text-sm space-y-2 list-disc pl-4">
                         <li>Analyze national team squad depth and balance.</li>
                         <li>Compare records against specific host country conditions.</li>
                         <li>Monitor weather patterns and their impact on DLS.</li>
                         <li>Evaluate historical head-to-head World Cup results.</li>
                      </ul>
                   </div>
                   <div className="space-y-4">
                      <h4 className="font-bold text-foreground flex items-center gap-2 italic uppercase text-sm">
          ...
          <div className="space-y-8">
            <div className="glass-card p-8 bg-primary/5 border-primary/20 sticky top-24">
              ...
              <h3 className="text-2xl font-black italic uppercase mb-4">T20 World Cup on Fairplay</h3>
              ...
              <div className="space-y-4">
                ...
                <Link
                  to="/schedule"
                  className="block w-full text-center bg-white/5 border border-white/10 py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-white/10 transition-all"
                >
                  Open the schedule
                </Link>
              </div>
