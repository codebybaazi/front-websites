...
const comparisonData = [
  ...
  },
  {
    ...
    skyexchange: "Often 4-6% hidden margins on premium markets.",
    winner: "fairplay"
  },
  {
  ...
  },
  {
    ...
    skyexchange: "Basic referral bonuses, no consistent VIP architecture.",
    winner: "fairplay"
  },
  {
        ...
        <div className="container max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-12">
              Looking for a more reliable alternative to Skyexchange? We've benchmarked Fairplay's next-gen infrastructure against legacy exchanges to help you make the right choice.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                a: "The primary reasons are superior liquidity, faster site performance, and a more robust VIP program. Fairplay is engineered to handle high-volume trading without the lag often associated with legacy exchanges like Skyexchange."
              },
              {
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto font-medium">
              Tired of legacy exchange limitations? Upgrade to Fairplay and experience the future of Indian cricket betting.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <a 
                href={waLink("Hello Fairplay! I'm switching from Skyexchange and want to get started with an Elite ID.")}
                target="_blank"
