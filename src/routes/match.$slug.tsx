...
function MatchDetailPage() {
  ...
  const derived = useMemo(() => {
    ...
    const faqs = cricketMatch && projection
      ...
      : [
          { q: `How do I get a Fairplay ID for ${match.event}?`, a: `WhatsApp the cricket desk. You get a Fairplay ID, then log in with OTP on that mobile.` },
          { q: `Are the win probabilities for ${match.event} live prices?`, a: `They are a lean from this page, not a live slip. Confirm the price after you log in.` },
          { q: `When does ${match.event} settle on Fairplay?`, a: `Withdrawals usually follow about 180 minutes after the official result, if KYC is clear and no book is still in play.` },
          { q: `How do I bet ${match.event} on Fairplay?`, a: `Open the match on your Fairplay ID after you fund with UPI. Confirm the slip before you send.` },
        ];
    return {
      teamA,
      teamB,
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                      <motion.div 
                        ...
                        className="h-full bg-primary shadow-[0_0_10px_rgba(47,185,74,0.5)]" 
                      />
                    </div>
                  </div>
                </div>
