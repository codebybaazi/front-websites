        ...
        <div className="container max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-bold tracking-widest uppercase mb-8">
              <AlertTriangle className="w-4 h-4" /> Information, not a guarantee
            </div>
          ...
          <div className="grid gap-12 max-w-5xl mx-auto">
            ...
            >
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-3xl font-bold tracking-tight">Who this <span className="text-primary">desk is for</span></h2>
              </div>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Fairplay is for users aged 18 and above. You can lose the stake. Pages here are information, not tips you must follow. The price that counts is on the slip after you log in.
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-bold tracking-tight">Restricted <span className="text-primary">states</span></h3>
                </div>
                <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                  Access is not offered to residents of Telangana, Odisha, Assam, Sikkim and Nagaland. If that is where you live, do not open or use a Fairplay ID.
                </p>
                <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-primary">
                  <Zap className="w-4 h-4" /> Follow local law
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-bold tracking-tight">No profit <span className="text-primary">promise</span></h3>
                </div>
                <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                  Fairplay does not guarantee winnings. Stake what you can afford to lose. A lost password is your responsibility — never share OTP.
                </p>
                <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-primary">
                  <Star className="w-4 h-4 fill-primary" /> See responsible gaming
                </div>
              </motion.div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 flex gap-6 items-start">
                ...
                <div>
                  <h4 className="text-2xl font-bold tracking-tight mb-4">Schedule pages can lag</h4>
                  <p className="text-muted-foreground leading-relaxed max-w-2xl">
                    Match details, timings and displayed odds can change. Confirm the live price on the Fairplay slip. This page is not legal advice about cricket IDs in your state.
                  </p>
                </div>
              </div>
            </motion.div>
