    ...
    handlers: {
      GET: async () => {
        ...
        const staticPaths: string[] = [
          ...
          "/big-win-stories", "/how-to-deposit", "/cricbet99-deposit-number", "/how-to-withdraw", "/cricbet99-withdrawl-number", "/support",
          "/whatsapp-support", "/cricbet99-customer-care-number", "/champions-trophy-betting", "/esports", "/reviews",
