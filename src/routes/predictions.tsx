  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Today Cricket Match Prediction — Who Will Win & Live Odds" },
        { name: "twitter:title", content: "Today Cricket Match Prediction — Who Will Win & Live Odds" },
      ...
      { property: "og:image:alt", content: "Today's cricket match prediction on Mahadev Book" },
