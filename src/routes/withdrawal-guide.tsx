    ...
    <div className="flex flex-col min-h-screen bg-background overflow-hidden">
        ...
        <div className="container max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-bold tracking-widest uppercase mb-8">
              <Star className="w-4 h-4 fill-primary" /> UPI and bank payouts
            </div>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter italic mb-8 leading-[0.9] uppercase">
              Fairplay <span className="text-primary not-italic">withdrawal</span>
            </h1>
          ...
          <div className="container max-w-5xl mx-auto px-4 mb-12">
            <AIOverview title="Settlement Intelligence Report" />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-4 py-24">
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {methods.map((method, i) => (
            <motion.div 
              ...
              className="glass-card p-8 border-primary/10 text-center hover:border-primary/40 transition-all group"
            >
              <method.icon className="w-12 h-12 text-primary mx-auto mb-6 group-hover:scale-110 transition-transform duration-500" />
              <h3 className="text-xl font-black italic uppercase mb-3">{method.name}</h3>
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="glass-card p-10 md:p-16 border-primary/20 space-y-12 rounded-[40px]"
        >
          <section>
          ...
          <section className="bg-primary/5 p-8 rounded-3xl border border-primary/20 flex flex-col md:flex-row items-center gap-8">
