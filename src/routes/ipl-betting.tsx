        ...
        <div className="container max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter italic mb-8 leading-[0.9] uppercase">
              IPL <span className="text-primary not-italic">betting 2026</span>
            </h1>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="glass-card p-8 md:p-12 border-primary/10">
                <h2 className="text-3xl font-black italic uppercase mb-6">How to bet IPL on <span className="text-primary">Fairplay</span></h2>
                <div className="space-y-6 text-muted-foreground leading-relaxed">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
                    <div className="space-y-4">
                      <h3 className="font-bold text-foreground flex items-center gap-2 italic uppercase">
            ...
            <div className="space-y-8">
              <div className="glass-card p-8 bg-primary/5 border-primary/20 sticky top-24">
                ...
                <h3 className="text-2xl font-black italic uppercase mb-4">IPL on a <span className="text-primary">Fairplay ID</span></h3>
                <p className="text-sm text-muted-foreground mb-8">
                  WhatsApp for the ID, fund with UPI, then open tonight’s IPL book. Same cricket ID as T20 and Test.
                </p>
                <div className="space-y-4">
                  <a
                  ...
                  <Link to="/schedule" className="w-full bg-white/5 border border-white/10 py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-white/10 transition-all flex items-center justify-center">
                    2026 schedule
                  </Link>
                  <Link to="/betting" search={{ category: 'cricket' }} className="w-full bg-white/5 border border-white/10 py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-white/10 transition-all flex items-center justify-center">
                    Cricket exchange
                  </Link>
                </div>
                <div className="mt-8 pt-6 border-t border-white/10 text-center">
                  <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold">Official Fairplay Network Partner</p>
                </div>
              </div>
            </div>
          </div>
