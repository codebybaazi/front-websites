        ...
        <div className="mx-auto grid max-w-7xl gap-14 px-6 py-8 sm:py-12 lg:grid-cols-[1.15fr_1fr] lg:py-28">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              ...
              <Link to="/how-it-works" className="text-sm font-semibold text-foreground/80 underline-offset-4 hover:text-primary hover:underline">
                See how it works →
              </Link>
            </div>
            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-between gap-3">
                  <img src={logo} alt="Cricbet99" className="h-7 w-auto shrink-0 drop-shadow-[0_4px_14px_rgba(0,0,0,0.55)] sm:h-8" />
