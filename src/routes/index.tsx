...
const steps = [
  { icon: MessageCircle, title: "Message us on WhatsApp", desc: <>Tap the WhatsApp button. A verified Cricbet99 manager responds within 60 seconds. Learn more about our <Link to="/whatsapp-number" className="text-primary font-bold hover:underline">Support Numbers</Link> and <Link to="/whatsapp-support" className="text-primary font-bold hover:underline">Human Support</Link>.</> },
  { icon: KeyRound, title: "Share basic details", desc: <>Full name and mobile number is all we need. Read our <Link to="/privacy-policy" className="text-primary font-bold hover:underline">Privacy Policy</Link> for data safety details and <Link to="/kyc-policy" className="text-primary font-bold hover:underline">KYC Info</Link>.</> },
    ...
    <SiteLayout>
      ...
      <section className="relative overflow-hidden border-t border-primary/15 py-28">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          <div className="relative mt-16 overflow-hidden rounded-3xl border-2 border-accent/70 p-4 shadow-[0_0_60px_-12px_color-mix(in_oklab,var(--accent)_55%,transparent)] sm:p-6">
            <div
              aria-hidden
