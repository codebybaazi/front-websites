...
export const CASES: Record<string, PageContent> = {
  "ipl-5000-to-25000-profit": {
    ...
    sections: [
      ...
      {
        heading: "The bet",
        body: "₹3,000 on the underdog match winner at 2.6. ₹2,000 on session over 55 runs in the first six overs at 1.85.",
      },
      {
        heading: "The outcome",
        body: "Underdog won by four wickets after a 62-run powerplay. Both markets settled — total return ₹25,000, net profit ₹20,000.",
      },
      {
        heading: "The payout",
  ...
  "small-budget-betting-strategy": {
    ...
    sections: [
      {
        heading: "The rules",
        body: "Never more than 5% of bankroll on any bet. Only markets where the player had recent form knowledge. No live/tilt betting.",
      },
      {
        heading: "The progression",
        body: "Week one: ₹1,000 → ₹1,650 across 12 bets. Week two: ₹1,650 → ₹3,800. Week three: ₹3,800 → ₹8,000.",
      },
      {
  ...
  "toss-market-10-minute-profit": {
    ...
    sections: [
      ...
      {
        heading: "The result",
        body: "Toss won. Payout ₹5,550, net profit ₹2,550. Total elapsed time: nine minutes.",
      },
    ],
  },
  "live-betting-3x-returns": {
    ...
    sections: [
      {
        heading: "The bankroll",
        body: "Started at ₹10,000. Rule: never more than ₹1,500 on any live market.",
      },
      {
        heading: "The bets",
        body: "Match 1: session over after early wickets, ₹800 → ₹1,760. Match 2: match-winner switch after 10 overs, ₹1,200 → ₹2,900. Match 3: over/under 170 flip mid-innings, ₹1,000 → ₹1,850. Match 4: last-over runs market, ₹1,500 → ₹3,600.",
      },
      {
        heading: "The result",
