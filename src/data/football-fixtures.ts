...
export const footballFixtures: FootballFixture[] = [
  // --- FIFA WORLD CUP 2026 ---
  {
    ...
    marketHighlights: ["Match Winner", "Total Goals O/U 2.5", "BTTS - Yes", "Anytime Goalscorer", "Asian Handicap"],
    keywords: ["mexico vs south africa prediction", "wc 2026 opening match betting", "mexico vs south africa odds", "football prediction today", "fifa world cup 2026 schedule"],
    ...
    bettingTips: [
      "Mexico's home advantage at the high-altitude Estadio Azteca is a key metric for Asian Handicap markets. Our football prediction today favors the host nation.",
      "Expect a aggressive tactical high-press in the opening quarter; back 'Early Goal' markets for premium value in your tonight world cup match strategy.",
      "Santiago Giménez to score anytime is the top-rated AI pick for this fixture. Check live football betting odds on Cricbet99 for the best value."
    ],
  ...
  },
  {
    ...
    stage: "Group A",
    category: "Group Stage",
    marketHighlights: ["Match Winner", "Total Goals Over 1.5", "Son Heung-min Anytime Goal", "Asian Handicap -0.5", "Draw No Bet"],
    keywords: ["korea republic vs czechia prediction", "south korea world cup betting", "estadio akron match odds", "today football match prediction", "fifa world cup games"],
    ...
    bettingTips: [
      "South Korea's high-pressing intensity usually peaks in the first 30 minutes. A solid today football match prediction suggests early pressure from the Koreans.",
      "Czechia's aerial threat from set-pieces is a significant market factor to monitor. Look for value in 'Total Goals Over 1.5' for this world cup match.",
      "Back 'Over 8.5 Corners' given both teams' tendency to attack via the wings. This is a top expert free tip for the group stage."
    ],
  ...
  },
  {
    ...
    stage: "Group B",
    category: "Group Stage",
    marketHighlights: ["Match Winner", "Canada Over 1.5 Goals", "Jonathan David to Score", "Both Teams to Score", "First Half Goals"],
    keywords: ["canada vs bosnia prediction", "bmo field world cup odds", "alphonso davies betting props", "football prediction today", "world cup schedule"],
    ...
    bettingTips: [
      "Canada's home crowd at BMO Field provides a +0.5 goal tactical xG superiority. Our football prediction today favors the hosts to dominate possession.",
      "Edin Džeko remains a potent threat in the air; monitor dominance in 'Total Corners' and 'Aerial Duel' markets for tonight's world cup match.",
      "Canada's high-line defense could be vulnerable to Džeko's intelligent movement. Check latest world cup odds on Cricbet99 for BTTS value."
    ],
  ...
  },
  {
    ...
    stage: "Group D",
    category: "Group Stage",
    marketHighlights: ["Match Winner", "USA -1 Handicap", "Christian Pulisic Anytime Goal", "Total Corners Under 10.5", "Clean Sheet - USA"],
    keywords: ["usa vs paraguay prediction", "world cup 2026 sofi stadium betting", "usmnt betting odds", "today football prediction", "fifa world cup 2026 schedule"],
    ...
    bettingTips: [
      "Pulisic's performance in Los Angeles has historically been elite; back him for a 'Man of the Match' performance in this today football match prediction.",
      "Paraguay's defensive structure is vulnerable to quick lateral switches; back 'USA Total Crosses Over 15.5' in your world cup betting strategy.",
      "Almirón's pace on the break is Paraguay's only consistent threat; watch for counter-attacking goals. Expert free tips suggest USA -1 Handicap."
    ],
  ...
  },
  {
    ...
    stage: "Group D",
    category: "Group Stage",
    marketHighlights: ["Match Winner", "Both Teams to Score", "Over 2.5 Goals", "Hakan Calhanoglu Anytime Goal", "Total Corners Over 9.5"],
    keywords: ["australia vs turkey prediction", "bc place soccer betting", "socceroos vs turkey odds", "football bets today", "today football prediction"],
    ...
    bettingTips: [
      "Türkiye's technical midfield quality gives them a distinct edge in ball retention markets. This is a top-rated football prediction today for possession stats.",
      ...
      "The 'Both Teams to Score' market is statistically favored given both teams' recent defensive lapses. Check latest football bets today on Cricbet99."
    ],
  ...
  },
  {
    ...
    stage: "Group C",
    category: "Group Stage",
    marketHighlights: ["Match Winner", "Both Teams to Score", "Over 2.5 Goals", "Asian Handicap -1.5", "First Scorer"],
    keywords: ["brazil vs morocco world cup 2026", "brazil vs morocco betting odds", "vinicius jr anytime scorer", "football prediction today", "world cup schedule"],
    ...
    bettingTips: [
      "Brazil's offensive depth is unmatched; back them in the 'Race to 2 Goals' market. Our today football match prediction favors a high-scoring Brazilian victory.",
      "Morocco's organized defensive block makes 'Under 1.5 Goals 1st Half' a strong statistical play in your world cup betting strategy.",
      "Vinícius Júnior is in peak form; back him for 'First Goalscorer' for high-yield returns. Check live world cup odds only on Cricbet99."
    ],
