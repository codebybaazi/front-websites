...
const GROUPS: { heading: string; links: QuickLink[] }[] = [
...

  {
    ...
    links: [
      ...
      { to: "/sprinters-book-deposit-number", label: "Deposit Number", title: "Sprinters Book deposit number WhatsApp" },
      { to: "/sprinters-book-withdrawl-number", label: "Withdrawal Number", title: "Sprinters Book withdrawal number WhatsApp" },
      { to: "/sprinters-book-customer-care-number", label: "Customer Care Number", title: "Sprinters Book customer care number WhatsApp" },
