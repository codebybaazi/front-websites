...
export function AIPoweredOverview({
  ...
  summary,
  eyebrow = "AI overview",
  badge = "Generated summary",
  highlights = [],
  sources = [],
  footnote = "Plain-language summary for this Fairplay page — no odds advice.",
  className = "",
  ...
  return (
    <motion.section
      ...
      className={`relative overflow-hidden rounded-[40px] border border-primary/20 bg-gradient-to-br from-primary/10 via-primary/[0.04] to-transparent ${className}`}
    >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2
                ...
                className="text-2xl md:text-3xl font-black italic uppercase text-white leading-none"
              >
                {title}
              </h2>
            </div>
