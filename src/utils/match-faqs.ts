...
function buildFaqPool(ctx: FaqCtx): MatchFaq[] {
  ...
  return [
    ...
    },
    {
      ...
      a: `The Fairplay wallet is usually credited within 180 minutes after ${ctx.event} is officially completed at ${ctx.venueShort}. ${ctx.formatLabel} result, innings, and fancy markets from ${ctx.teamA} vs ${ctx.teamB} post to the same exchange wallet — you do not wait on a bookmaker cycle.`,
    },
    {
